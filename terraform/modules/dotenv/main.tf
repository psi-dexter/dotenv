...
resource "local_file" "p10k_zsh" {
  content         = file("${path.module}/templates/p10k.zsh.tpl")
  filename        = "/Users/${var.user}/.p10k.zsh"
  file_permission = "0740"
}
resource "local_file" "sublime_terminus" {
  content         = file("${path.module}/sublime/Terminus.sublime-settings")
  filename        = "/Users/${var.user}/Library/Application Support/Sublime Text/Packages/User/Terminus.sublime-settings"
